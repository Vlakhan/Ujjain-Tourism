...
public class VActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageList.add(new SlideModel(R.drawable.vmart1,null));
        imageList.add(new SlideModel(R.drawable.vmart2,null));
        imageList.add(new SlideModel(R.drawable.vmart3,null));
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String destination = "V mall ujjain";
